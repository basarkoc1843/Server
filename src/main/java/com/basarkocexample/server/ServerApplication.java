package com.basarkocexample.server;
...
import static com.basarkocexample.server.enumarition.Status.SERVER_UP;
...
public class ServerApplication {
	...
	CommandLineRunner run(ServerRepo serverRepo) {
		return args -> {
			serverRepo.save(new Server(null, "192.168.1.160", "Ubuntu Linux", "16 GB", "Personel Pc", "http://localhost:8080/server/image/server1.png", SERVER_UP));
